...
export default async function IndexPage() {
  ...
  if (!project.config.clientTeamCreationEnabled) {
    return (
      <div
        ...
        data-oid="2wil5z6"
      >
        <div className="max-w-xl gap-4" data-oid="k58._5q">
          <p className="font-bold text-xl" data-oid="p:p91b6">
            Setup Required
          </p>
          <p className="" data-oid="q.0w551">
            {
  ...
  return (
    <>
      ...
      <div id="features" data-oid="f3:m5kf" />
      <FeatureGrid
        title="Features"
        ...
        items={[
          ...
          {
            icon: <Users className="h-12 w-12" data-oid="4v8j3kx" />,
            title: "Multi-tenancy & RBAC",
            description: "Built-in Teams and Permissions.",
          },
          {
            icon: <GitHubLogoIcon className="h-12 w-12" data-oid="6wg7fq2" />,
            title: "100% Open-source",
            description: "Open-source and self-hostable codebase.",
          },
          {
            icon: <ComponentIcon className="h-12 w-12" data-oid="vjwt3yu" />,
      ...
      <div id="pricing" data-oid=".u5oija" />
      <PricingGrid
        title="Pricing"
